...
export const projects: Project[] = [
  // ── ANTenna ──
  {
    ...
    period: "2025.11. – 현재",
    overview: [
      { label: "소개", value: "한국/미국 주식의 시세, 재무제표, 실적 서프라이즈, 시장 지표 등 2,300만 건 이상의 데이터를 수집·분석하고, 규칙 기반 백테스팅과 ML/DL 퀀트 모델링까지 제공하는 개인 풀스택 프로젝트" },
    ...
    sections: [
      ...
      },
      {
        ...
        subSections: [
          ...
          {
            title: "통계 + AI 퀀트 모델링 (진행 중)",
            blocks: [
              {
                type: "text",
                body: "단순 규칙 기반 백테스팅을 넘어, ML/DL/통계 모델을 앙상블하여 주가 방향성을 예측하는 퀀트 모델링을 설계·개발 중입니다.",
              },
              {
                type: "list",
                items: [
                  "XGBoost(ML) + TCN(DL) + SARIMAX(통계) 앙상블 예측",
                  "200+ 피처 엔지니어링 (기술적 지표, 재무 비율, 시장 지표 등)",
                  "Walk-forward 검증으로 미래 데이터 누출 방지",
                ],
              },
            ],
          },
